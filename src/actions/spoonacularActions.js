export const FETCH_RECIPES_FROM_SPOONACULAR_REQUEST =
  "FETCH_RECIPES_FROM_SPOONACULAR_REQUEST";
export const fetchRecipesFromSpoonacularRequest = () => ({
  type: FETCH_RECIPES_FROM_SPOONACULAR_REQUEST
});

export const FETCH_RECIPES_FROM_SPOONACULAR_SUCCESS =
  "FETCH_RECIPES_FROM_SPOONACULAR_SUCCESS";
export const fetchRecipesFromSpoonacularSuccess = recipes => ({
  type: FETCH_RECIPES_FROM_SPOONACULAR_SUCCESS,
  recipes
});

export const FETCH_RECIPES_FROM_SPOONACULAR_ERROR =
  "FETCH_RECIPES_FROM_SPOONACULAR_ERROR";
export const fetchRecipesFromSpoonacularError = error => ({
  type: FETCH_RECIPES_FROM_SPOONACULAR_ERROR,
  error
});

export const FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_REQUEST =
  "FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_REQUEST";
export const fetchSingleRecipeFromFromSpoonacularRequest = () => ({
  type: FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_REQUEST
});

export const FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_SUCCESS =
  "FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_SUCCESS";
...
export const FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_ERROR =
  "FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_ERROR";
export const fetchSingleRecipeFromSpoonacularError = error => ({
  type: FETCH_SINGLE_RECIPE_FROM_SPOONACULAR_ERROR,
  error
});

export const FETCH_RECIPES_INBULK_FROM_SPOONACULAR_REQUEST =
  "FETCH_RECIPES_INBULK_FROM_SPOONACULAR_REQUEST";
export const fetchRecipesInbulkFromSpoonacularRequest = () => ({
  type: FETCH_RECIPES_INBULK_FROM_SPOONACULAR_REQUEST
});

export const FETCH_RECIPES_INBULK_FROM_SPOONACULAR_SUCCESS =
  " FETCH_RECIPES_INBULK_FROM_SPOONACULAR_SUCCESS";
export const fetchRecipesInbulkFromSpoonacularSuccess = recipes => ({
  type: FETCH_RECIPES_INBULK_FROM_SPOONACULAR_SUCCESS,
  recipes
});

export const FETCH_RECIPES_INBULK_FROM_SPOONACULAR_ERROR =
  " FETCH_RECIPES_INBULK_FROM_SPOONACULAR_ERROR";
...
export const fetchRecipesFromSpoonacular = queryString => dispatch => {
  ...
  return fetch(
    `https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/findByIngredients?fillIngredients=false&ingredients=${queryString}&limitLicense=false&number=12&ranking=1`,
    {
      cache: "no-cache",
...
export const fetchRecipesFromSpoonacularInBulk = idString => dispatch => {
  ...
  return fetch(
    ...
    .then(results => results.json())
    .then(recipes =>
      dispatch(fetchRecipesInbulkFromSpoonacularSuccess(recipes))
    )

...
export const fetchRecipesFromSpoonacular = (queryString) => (dispatch) =>  {
    ...
    return fetch(`https://spoonacular-recipe-food-nutrition-v1.p.mashape.com/recipes/findByIngredients?fillIngredients=false&ingredients=${queryString}&limitLicense=false&number=12&ranking=1`, {
              cache: 'no-cache', 

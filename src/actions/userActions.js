...
export const FETCH_RECIPES_FROM_DATABASE_REQUEST =
  "FETCH_RECIPES_FROM_DATABASE_REQUEST";
export const fetchRecipesFromDatabaseRequest = () => ({
  type: FETCH_RECIPES_FROM_DATABASE_REQUEST
});

export const FETCH_RECIPES_FROM_DATABASE_SUCCESS =
  "FETCH_RECIPES_FROM_DATABASE_SUCCESS";
export const fetchRecipesFromDatabaseSuccess = recipes => ({
  type: FETCH_RECIPES_FROM_DATABASE_SUCCESS,
  recipes
});

export const FETCH_RECIPES_FROM_DATABASE_ERROR =
  "FETCH_RECIPES_FROM_DATABASE_ERROR";
export const fetchRecipesFromDatabaseError = error => ({
  type: FETCH_RECIPES_FROM_DATABASE_ERROR,
  error
});

export const POST_RECIPE_TO_DATABASE_REQUEST =
  "POST_RECIPE_TO_DATATBASE_REQUEST";
export const postRecipeToDatabaseRequest = () => ({
  type: POST_RECIPE_TO_DATABASE_REQUEST
});

export const POST_RECIPE_TO_DATABASE_SUCCESS =
  "POST_RECIPE_TO_DATATBASE_SUCCESS";
...
export const REMOVE_RECIPE_FROM_DATABASE_REQUEST =
  "REMOVE_RECIPE_FROM_DATABASE_REQUEST";
export const removeRecipeFromDatabaseRequest = () => ({
  type: REMOVE_RECIPE_FROM_DATABASE_REQUEST
});

export const REMOVE_RECIPE_FROM_DATABASE_SUCCESS =
  "REMOVE_RECIPE_FROM_DATABASE_SUCCESS";
export const removeRecipeFromDatabaseSuccess = () => ({
  type: REMOVE_RECIPE_FROM_DATABASE_SUCCESS
});

export const REMOVE_RECIPE_FROM_DATABASE_ERROR =
  "REMOVE_RECIPE_FROM_DATABASE_ERROR";
...
export const fetchRecipeIdsFromDatabase = (userId, authToken) => dispatch => {
  ...
  return fetch(`${API_BASE_URL}/api/recipes/?userId=${userId}`, {
    ...
    .then(res => {
      if (!res.ok) {
        return dispatch(fetchRecipesFromDatabaseError(res.statusText));
      }
      return res.json();
    })
...
export const postRecipeToDatabase = (
  recipeId,
  userId,
  authToken
) => dispatch => {
...
export const updateStateWithDatabaseResults = (
  userId,
  authToken
) => dispatch => {
